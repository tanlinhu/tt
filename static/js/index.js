...
(function () {
  ...
  var option = {
    ...
    yAxis: [{
      ...
      data: [41980, 35229, 33872, 33867, 30999]
    }],
    series: [{
        // 第一组柱子（条状）
        name: '条',
        ...
        data: [41.98, 35.23, 39.9, 33.87, 31],
        // 显示柱子内的百分比文字
        label: {
          show: true,
          position: "inside",
...
(function () {
  ...
  var yearData = [{
      ...
      data: [
        // 两个数组是因为有两条线
        [21.48, 44.83, 73.31, 157.04, 307.46, 430.85, 607.60],
        [244.21, 302.21, 493.46, 498.77, 448.44, 436.30, 400.53]
      ]
    },
    {
      year: "2021", // 年份
...
(function () {
  ...
  var option = {
    ...
    series: [{
        ...
        data: [29755, 35625, 51943, 58495, 65355, 68685, 72334]
      },
      {
        name: "女性",
        type: "line",
        ...
        // 开始不显示拐点， 鼠标经过显示
        showSymbol: false,
        data: [27665, 33806, 48874, 54873, 61228, 65287, 68844]
      }
    ]
  };
